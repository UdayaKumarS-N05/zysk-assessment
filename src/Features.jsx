    ...
    <div className="mt-24 w-full flex flex-col items-center justify-center h-fit pb-16 ">
      ...
      <div className="w-full mt-4 grid grid-rows-2 grid-cols-3 px-10 gap-y-16 md:block md:px-2 ">
        <div className="flex flex-col items-center md:w-full">
          ...
          >
            <g filter="url(#filter0_d_3378_672)">
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_3378_672"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_672"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className="flex flex-col items-center md:w-full md:mt-12">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3378_680)">
              <rect x="2" y="1" width="48" height="48" rx="10" fill="white" />
              <rect
                x="2.5"
                y="1.5"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_3378_680"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_680"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className="flex flex-col items-center md:w-full md:mt-12">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3378_688)">
              <rect x="2" y="1" width="48" height="48" rx="10" fill="white" />
              <rect
                x="2.5"
                y="1.5"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_3378_688"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_688"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className="flex flex-col items-center md:w-full  md:mt-12">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3378_697)">
              <rect x="2" y="1" width="48" height="48" rx="10" fill="white" />
              <rect
                x="2.5"
                y="1.5"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_3378_697"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_697"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className="flex flex-col items-center md:w-full  md:mt-12">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3378_705)">
              <rect x="2" y="1" width="48" height="48" rx="10" fill="white" />
              <rect
                x="2.5"
                y="1.5"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_3378_705"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_705"
                  result="shape"
                />
              </filter>
            </defs>
        ...
        <div className="flex flex-col items-center md:w-full md:mt-12 md:mb-16">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g filter="url(#filter0_d_3378_713)">
              <rect x="2" y="1" width="48" height="48" rx="10" fill="white" />
              <rect
                x="2.5"
                y="1.5"
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_3378_713"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3378_713"
                  result="shape"
                />
              </filter>
            </defs>
